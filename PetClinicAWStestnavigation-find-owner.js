...
// for details
  ...
  // Test Case: PetClinic-AWS-test-navigation  
  .then(function (){
  	return Promise.resolve(true)
  
    .then( function(){return logger.log(1,"Open URL http://ec2-54-149-39-98.us-west-2.compute.amazonaws.com/","PetClinic-AWS-test-navigation"),$browser.get("http://ec2-54-149-39-98.us-west-2.compute.amazonaws.com/").then(e=>e)})
    .then( function(){return logger.log(2,"Set Window Size Width=1903 Height=1026","PetClinic-AWS-test-navigation"),$browser.manage().window().setSize(1903,1026).then(e=>e)})
    .then( function(){return logger.log(3,"Click By.linkText(\"Find owners\")","PetClinic-AWS-test-navigation"),$browser.waitForAndFindElement(By.linkText("Find owners"),DefaultTimeout).then(e=>(e.click(),Promise.resolve(!0)))})
    .then( function(){return logger.log(4,"Click By.name(\"lastName\")","PetClinic-AWS-test-navigation"),$browser.waitForAndFindElement(By.name("lastName"),DefaultTimeout).then(e=>(e.click(),Promise.resolve(!0)))})
    .then( function(){return logger.log(5,"Type \"davis\" using locator By.name(\"lastName\")","PetClinic-AWS-test-navigation"),$browser.waitForAndFindElement(By.name("lastName"),DefaultTimeout).then(e=>(e.sendKeys("davis"),Promise.resolve(!0)))})
    .then( function(){return logger.log(6,"Click By.css(\"button\")","PetClinic-AWS-test-navigation"),$browser.waitForAndFindElement(By.css("button"),DefaultTimeout).then(e=>(e.click(),Promise.resolve(!0)))})
    .then( function(){return logger.log(7,"Click By.linkText(\"Betty Davis\")","PetClinic-AWS-test-navigation"),$browser.waitForAndFindElement(By.linkText("Betty Davis"),DefaultTimeout).then(e=>(e.click(),Promise.resolve(!0)))})
  	.then(function() {
  		logger.endTestCase("PetClinic-AWS-test-navigation");
  	}, function(err) {
  		logger.error (err, "PetClinic-AWS-test-navigation");
  		throw(err);
  	});
